	...
	\bookpart {
		\markup {
			\column {
				...
				\null
				\null
				\fill-line { \small "Git tag: 142" }
				\fill-line { \small "Git describe: 142-17-gaa06cac" }
				\fill-line { \small "Git commits: 1317" }
				\fill-line { \small "Build date: 02:10:56 05-11-2014" }
				...
				\fill-line { \small "Number of tunes: 135" }
				\null
				\null
				\null
			}
...
\chordmode {
	...
	\alternative {
		...
		}
		{
			...
			c2:maj7 a:7 | d:m7 g:7 | c1:6 | \LPC d2:m7 \RPC g:7 | \myEndLine
			\endPart
		}
	}
...
\tocItem \markup "I Got Plenty O' Nuttin' / George Gershwin, Ira Gershwin, DuBose Hayward"
...
%% just a little space
	\null
	\fill-line {
		\smaller \smaller { "Copyright © 1935 Gershiwin Publishing Corporation" }
	}
	\fill-line {
		\smaller \smaller { "Typeset by Jordan Eldredge <JordanEldredge@gmail.com>" }
	}
...
\tocItem \markup "This Can't Be Love / Richard Rogers, Lorenz Hart"
